        ...
        <Card className="border-amber-200 bg-amber-50">
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-amber-800">Active Lease</p>
                <p className="text-amber-900 font-semibold">
                  {activeLease.unit?.unitNumber} · {activeLease.unit?.property?.name}
                </p>
              </div>
              <div className="text-right">
                <p className="text-sm text-amber-700">
                  {new Date(activeLease.startDate).toLocaleDateString('en-AE')} →{' '}
                  {new Date(activeLease.endDate).toLocaleDateString('en-AE')}
                </p>
