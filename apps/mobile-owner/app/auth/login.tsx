    ...
    >
      <View style={styles.inner}>
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.logoSub}>Owner Portal</Text>
        </View>

        {step === 'phone' ? (
          <View>
            <Text style={styles.heading}>Welcome back</Text>
            <Text style={styles.subheading}>Manage your property portfolio</Text>
          ...
          <View>
            ...
            <Text style={styles.subheading}>Code sent to +971 {phone}</Text>
            <TextInput
            ...
            >
              {loading ? <ActivityIndicator color="#fff" /> : <Text style={styles.btnText}>Verify & Access</Text>}
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  logoDot: { width: 48, height: 48, borderRadius: 12, backgroundColor: '#10B981', marginBottom: 12 },
  logoText: { fontSize: 28, fontWeight: '800', color: '#ffffff' },
  logoSub: { fontSize: 14, color: '#6ee7b7', marginTop: 2 },
  heading: { fontSize: 22, fontWeight: '700', color: '#ffffff', marginBottom: 6 },
  subheading: { fontSize: 14, color: '#6ee7b7', marginBottom: 24 },
  phoneRow: { flexDirection: 'row', gap: 8, marginBottom: 16 },
  prefix: { backgroundColor: '#065f46', borderRadius: 10, paddingHorizontal: 12, justifyContent: 'center' },
  prefixText: { color: '#d1fae5', fontSize: 14 },
  phoneInput: {
    flex: 1, backgroundColor: '#065f46', borderRadius: 10, paddingHorizontal: 16,
    paddingVertical: 14, fontSize: 16, color: '#ffffff',
  },
  otpInput: {
    backgroundColor: '#065f46', borderRadius: 10, paddingHorizontal: 16,
  ...
  backText: { color: '#6ee7b7', fontSize: 14 },
  hint: { textAlign: 'center', color: '#064e3b', fontSize: 11, marginTop: 40 },
});
