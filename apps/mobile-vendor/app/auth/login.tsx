    ...
    >
      <View style={styles.inner}>
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.logoSub}>Vendor Portal</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  logoDot: { width: 48, height: 48, borderRadius: 12, backgroundColor: '#E2B93B', marginBottom: 12 },
  ...
  btn: { backgroundColor: '#E2B93B', borderRadius: 10, paddingVertical: 14, alignItems: 'center' },
